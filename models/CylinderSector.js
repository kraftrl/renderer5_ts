...
class CylinderSector extends Model {
    constructor(r = 1, h1 = 0, h2 = 1, theta1 = 0, theta2 = 2.0 * Math.PI, n = 10, k = 10) {
        ...
        let v = Array(n).fill(null).map(() => Array(k));
        ...
        for (let j = 0; j < k; ++j) // choose an angle of longitude
         {
            ...
            for (let i = 0; i < n; ++i) // choose a circle of latitude
             {
                v[i][j] = new Vertex(r * c, h1 + i * deltaH, r * s);
            }
        }
